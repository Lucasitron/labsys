...
/**
 * Tratamento centralizado de exceções do Notification Service (D-5: mensagens
 * não-técnicas em PT, sem stack/SQL).
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleLinkInvalido(LinkInvalidoException ex, HttpServletRequest request) {
