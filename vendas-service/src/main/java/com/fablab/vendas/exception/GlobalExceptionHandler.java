...
import com.fablab.vendas.dto.ErrorResponse;
...
/**
 * Tratamento centralizado de exceções com mensagens em PT-BR não-técnicas (D-8).
 */
...
public class GlobalExceptionHandler {
    ...
    /** Regra de negócio violada ou lock otimista em conflito (D-9 → 409). */
    ...
    public ResponseEntity<ErrorResponse> handleOptimisticLock(ObjectOptimisticLockingFailureException ex,
        ...
        return build(HttpStatus.CONFLICT,
                "O registro foi alterado por outro usuário. Atualize a tela e tente novamente.", request);
    }
